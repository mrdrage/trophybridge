-- Production parity hotfix for Supabase pgsql-http.
-- `http_headers(...)` is not available in the installed extension; construct
-- the `http_header[]` array explicitly instead.
